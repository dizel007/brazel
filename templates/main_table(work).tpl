...
{*<!-- *************************** парсер EXCEL файл  ********************************************** --> *}  
         ...
         {if ({$exist_excel_file.$i} == 1) }
             <td><a href="open_excel/parce_excel_kp.php?LinkKp={$array_with_all_kp.$i.LinkKp}" target="_blank"><img class="scale11" style = "opacity: 0.8" src="icons/see_excel.png" alt="Excel"></a></td>
         {else} 
